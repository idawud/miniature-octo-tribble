...
// declaring the variables that we want to use
...
// expressWinston.errorLogger needs to be set after we define our routes and before any of your custom error handlers (express.handler)
// https://www.npmjs.com/package/express-winston#error-logging
app.use(
